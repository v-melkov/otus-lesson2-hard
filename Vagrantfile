...
DONE
  ...
  config.vm.provision "shell", inline: <<-SHELL
     ...
     echo "!!!                                                                    !!!"
     echo "!!!    Если пропустили момент выбора диска, перезагрузитесь ещё раз    !!!"
     echo "!!!                 выберите при загрузке второй диск                  !!!"
     echo "!!!   и после входа в систему вручную запустите скрипт ./stage-2.sh    !!!"
     echo "!!!     (если прошло больше пяти минут после первой перезагрузки)      !!!"
